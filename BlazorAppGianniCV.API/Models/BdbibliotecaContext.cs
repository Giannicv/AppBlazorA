...
namespace BlazorAppGianniCV.API.Models;
...
public partial class BdbibliotecaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Iidautor).HasName("PK_Autors");
            ...
            entity.HasOne(d => d.IidpaisNavigation).WithMany(p => p.Autors)
                .HasForeignKey(d => d.Iidpais)
                .HasConstraintName("FK__Autor__IIDPAIS__412EB0B6");

            entity.HasOne(d => d.IidsexoNavigation).WithMany(p => p.Autors)
        ...
        modelBuilder.Entity<DetalleReserva>(entity =>
        {
            ...
            entity.HasOne(d => d.IidlibroNavigation).WithMany(p => p.DetalleReservas)
                .HasForeignKey(d => d.Iidlibro)
                .HasConstraintName("FK__DetalleRe__IIDLI__4316F928");

            entity.HasOne(d => d.IidreservaNavigation).WithMany(p => p.DetalleReservas)
        ...
        {
            entity.HasKey(e => e.Iidlibro).HasName("PK_Libros");

            entity.ToTable("Libro");

            entity.Property(e => e.Iidlibro).HasColumnName("IIDLIBRO");
            entity.Property(e => e.Bhabilitado).HasColumnName("BHABILITADO");
            entity.Property(e => e.Fotocaratula).HasColumnName("FOTOCARATULA");
            entity.Property(e => e.Iidautor).HasColumnName("IIDAUTOR");
            entity.Property(e => e.Iidtipolibro).HasColumnName("IIDTIPOLIBRO");
            entity.Property(e => e.Libropdf).HasColumnName("LIBROPDF");
            ...
            entity.HasOne(d => d.IidautorNavigation).WithMany(p => p.Libros)
                .HasForeignKey(d => d.Iidautor)
                .HasConstraintName("FK__Libro__IIDAUTOR__44FF419A");

            entity.HasOne(d => d.IidtipolibroNavigation).WithMany(p => p.Libros)
                .HasForeignKey(d => d.Iidtipolibro)
                .HasConstraintName("FK__Libro__IIDTIPOLI__45F365D3");
        });
        ...
        modelBuilder.Entity<PaginaTipoUsuButton>(entity =>
        {
            ...
            entity.HasOne(d => d.IidbuttonNavigation).WithMany(p => p.PaginaTipoUsuButtons)
                .HasForeignKey(d => d.Iidbutton)
                .HasConstraintName("FK__PaginaTip__IIDBU__48CFD27E");

            entity.HasOne(d => d.IidpaginatipousuarioNavigation).WithMany(p => p.PaginaTipoUsuButtons)
        ...
        modelBuilder.Entity<Reserva>(entity =>
        {
            ...
            entity.HasOne(d => d.IidestadoreservaNavigation).WithMany(p => p.Reservas)
                .HasForeignKey(d => d.Iidestadoreserva)
                .HasConstraintName("FK__Reserva__IIDESTA__4AB81AF0");
        });
        ...
        modelBuilder.Entity<ReservaHistorial>(entity =>
        {
            ...
            entity.HasOne(d => d.IidestadoNavigation).WithMany(p => p.ReservaHistorials)
                .HasForeignKey(d => d.Iidestado)
                .HasConstraintName("FK__ReservaHi__IIDES__4BAC3F29");

            entity.HasOne(d => d.IidreservaNavigation).WithMany(p => p.ReservaHistorials)
                .HasForeignKey(d => d.Iidreserva)
                .HasConstraintName("FK__ReservaHi__IIDRE__4CA06362");

            entity.HasOne(d => d.IidusuarioNavigation).WithMany(p => p.ReservaHistorials)
